...
/* USER CODE BEGIN PV */
uint32_t encoder1_value;
uint32_t encoder2_value;
uint32_t pot;

char encoder_buffer[800]={'\0'};
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  /*HAL_UART_Transmit(&huart1, (uint8_t*)encoder_buffer, sizeof(encoder_buffer), 300);*/


	  /*
	  sprintf(encoder_buffer, "first encoder: %d\n\r", ((TIM3->CNT)>>3));
	  CDC_Transmit_FS((uint8_t*)encoder_buffer, strlen(encoder_buffer));
	  HAL_Delay(500);*/
